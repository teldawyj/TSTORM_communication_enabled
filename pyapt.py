...
class APTMotor():
    def __init__(self, SerialNum=83840820, HWTYPE=31):
        '''
        ...
        '''
        self.Connected = True
        self.aptdll = windll.LoadLibrary("D:\storm-control-python3_pyqt5\storm-control-python3_pyqt5\storm_control\hal4000\my_hardware\APT.dll")
