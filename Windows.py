...
class MainWindow:
    ...
    def living(self):
        ...
        for i in range(0, num, step):
            ...
            if self.live_thread_flag == False:
                return (0)
            #put_picture_thread=threading.Thread(target=self.put_picture,args=(pixmap01,))
            #put_picture_thread.start()
    ...
    def put_picture(self,picture):
        self.ui.livewindow.setPixmap(picture)
    ...
    def recording(self):
        ...
        for i in self.frames:
            ...
            self.tiff.write_image(image)
            #tifffile.imsave(self.filename, image)
    ...
    def start_record(self):
        ...
        self.tiff = libtiff.TIFF.open(self.filename, mode='w')
